  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        setSuccess(`User "${formData.name}" registered successfully! A temporary password has been sent to their email.`);
        // Reset form
        setFormData({
          username: '',
          email: '',
    ...
    <div className="page-container">
      ...
      <div className="table-card" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <form onSubmit={handleSubmit} style={{ padding: '20px' }}>
          ...
          <div className="form-group" style={{ marginBottom: '20px', padding: '15px', background: '#f0f8ff', borderRadius: '6px', border: '1px solid #b3d9ff' }}>
            <p style={{ margin: 0, color: '#0066cc', fontSize: '14px' }}>
              <strong>ℹ️ Note:</strong> A temporary password will be automatically generated and sent to the user's email address.
            </p>
          </div>
